...
import { ApplicationList, ListTransaction, Landing, Login } from "./pages";
...
function App() {
  ...
  const [activUpdat, setActiveUpdate] = useState<boolean>(false);
                    ...
                    element={
                      <>
                        {<ListTransaction
                          ...
                          setActiveUpdate={setActiveUpdate} //React.Dispatch<React.SetStateAction<boolean>>;
                        />}
                      </>
                    }
                />
